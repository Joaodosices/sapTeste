(function() {
	...
	class ApsWebComponent extends HTMLElement {
		constructor() {
			...
			this._shadowRoot.getElementById("formVerticalLayout").addEventListener("submit", this._submitInitialValue.bind(this));
			this._shadowRoot.getElementById("formHorizontalLayout").addEventListener("submit", this._submitFinalValue.bind(this));
			this._option = "";
		}
