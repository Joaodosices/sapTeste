            ...
            // if (this.firstConnection === true){
                ...
                */
                ...
                let arrOptionsLinks = [
                    ...
                    `https://mota-engil.eu10.hcs.cloud.sap/sap/fpa/ui/app.html#/story&/s/9418470372A7B8B2F061BEBFE7CB7574/?mode=present&resourceType=STORY`],
                    [`Investimentos`,
                    `https://mota-engil.eu10.hcs.cloud.sap/sap/fpa/ui/app.html#/story&/s/FB98770372A52464690969DF59C198C2/?mode=present&resourceType=STORY`,
                    `https://mota-engil.eu10.hcs.cloud.sap/sap/fpa/ui/app.html#/story&/s/FB98770372A52464690969DF59C198C2/?mode=present&resourceType=STORY`],
                    [`Endividamento`,
                ...
                var optionSelected = ``
                var optionsShown = []
                _that._shadowRoot.querySelectorAll(`.btnFirstMenu`)[0].style.display = "none"
