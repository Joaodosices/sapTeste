		...
		onCustomWidgetAfterUpdate(oChangedProperties) {
            // if (this.firstConnection === true){
                ...
                */
                    ...
                    let arrMenuOptions =[
                        [`Informação Geral`, `analytics`],
                        [`DR`, `grouped_bar_chart`],
                        [`Volume de negócios`, `monitoring`],
                        [`OPEX`, `analytics`],
                        [`Clientes`, `group`],
                        [`Fornecedores`, `location_away`], 
                        [`Investimentos`, `price_change`],
                        [`Endividamento`, `currency_exchange`],
                        [`Fluxo de caixa e Orçamento de tesouraria`, `grouped_bar_chart`]
                    ]
                    //Campo 1 -> Nome do painel, Campo 2 -> url da imagem 
                    let arrMenuOptionsSecondMenu =[
                        [`Ajustamento tarifário`, `view_list`],
                        [`Desvio de Custos de Capital`, `monitoring`],
                        [`Desvio de Preço`, `monitoring`],
                        [`Indutores`, `location_away`],
                        [`Opex`, `analytics`],
                        [`Atividades Complementares`, `view_list`],
                        [`Desvio incremental`, `grouped_bar_chart`],
                        [`Desvio de quantidade`, `analytics`]
                    ]
                    ...
                    tempText = tempText + ` 
                        <div class='card areaOption areaOption` + cont + `'>
                            <div class='optionCircle front'>
                                <span class="material-symbols-outlined size-72">"` + arrMenuOptions[i][1] + `"</span>
                                <div class='areaText'> 
                ...
                for (let i = 0; i < arrMenuOptionsSecondMenu.length; i++) {
                    tempText = ` 
                        <div class='card areaOption secondMenuArea'>
                            <div class='optionCircle front'>
                                <span class="material-symbols-outlined size-72">"` + arrMenuOptionsSecondMenu[i][1] + `"</span>
                                <div class='areaText'> 
